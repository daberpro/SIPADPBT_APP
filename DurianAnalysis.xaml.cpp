#include "pch.h"
#include "DurianAnalysis.xaml.h"
#if __has_include("DurianAnalysis.g.cpp")
#include "DurianAnalysis.g.cpp"
#endif
...
namespace winrt::SIPADPBT::implementation
{
    DurianAnalysis::DurianAnalysis() {
        ...
        this->Loaded([&](IInspectable const&, RoutedEventArgs const&)-> Windows::Foundation::IAsyncAction {
            ...
            for (auto& data : indexData["durian"]["gejala"]) {
                inputData.push_back({
            ...
            index = 0;
            for (auto& data : indexData["durian"]["penyakit"]) {
                diseases.push_back({
    ...
    winrt::Windows::Foundation::Collections::IObservableVector<winrt::SIPADPBT::Model> DurianAnalysis::questionnaire()
    {
        return this->m_questionnaire;
    }

    winrt::Windows::Foundation::Collections::IObservableVector<winrt::SIPADPBT::ModelDisease> DurianAnalysis::disease() {
        return this->m_disease;
    }

    Windows::Foundation::IAsyncAction DurianAnalysis::ReadFileFromAssets(winrt::hstring path, winrt::hstring& result) {
    ...
    void DurianAnalysis::reset(IInspectable const& sender, Microsoft::UI::Xaml::RoutedEventArgs const&) {
    ...
    void DurianAnalysis::ChangeSelection(IInspectable const& sender, Microsoft::UI::Xaml::RoutedEventArgs const&) {
    ...
    void DurianAnalysis::SelectionLoaded(IInspectable const& sender, Microsoft::UI::Xaml::RoutedEventArgs const&) {
        auto& element = sender.as<Microsoft::UI::Xaml::Controls::RadioButtons>();
        auto& dataContext = element.DataContext().as<winrt::SIPADPBT::Model>();
        uint32_t indexData;
        this->m_questionnaire.IndexOf(dataContext, indexData);
    ...
    void DurianAnalysis::Show_Info(IInspectable const& sender, Microsoft::UI::Xaml::RoutedEventArgs const&) {
    ...
    void DurianAnalysis::Explain(IInspectable const& sender, Microsoft::UI::Xaml::RoutedEventArgs const&) {
    ...
    Windows::Foundation::IAsyncAction DurianAnalysis::Analyze(IInspectable const& sender, Microsoft::UI::Xaml::RoutedEventArgs const&) {
        ...
        std::thread get_analyze([&](std::string&& core_path)-> void {
            ...
            mlpack::data::Load(
                (core_path + "\\model-durian.bin").c_str(),
                "model",
                model,
                false
            );
