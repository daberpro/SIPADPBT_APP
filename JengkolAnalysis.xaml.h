...
{
    struct JengkolAnalysis : JengkolAnalysisT<JengkolAnalysis>
    {
        JengkolAnalysis();
...
{
    struct JengkolAnalysis : JengkolAnalysisT<JengkolAnalysis, implementation::JengkolAnalysis>
    {
    };
}
